...
def fast(
  ...
  """Produce a FromDisk compatible file layour under the provided directory.
  ...
  Returns:
    A tuple whose first element is the fully-qualified path to the config file,
    and whose second element is an ordered tuple list whose elements are the
    filenames containing: (sha256, .tar.gz) respectively.
  """
